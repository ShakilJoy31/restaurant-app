...
const cart = () => {
    ...
    return (
        <div className='mx-12'>
            <h1 className='flex justify-center mb-8 text-5xl font-bold text-accent'>Food, you have added to the cart</h1>
            <div>
                {
                    ...
                    isCartFoodModal && <div>
                        ...
                        <label htmlFor="my-modal-4" className="cursor-pointer modal">
                            <label className="relative modal-box" htmlFor="">
                                <h3 className="flex justify-center mb-6 text-3xl font-bold text-red-600">Are you sure?</h3>
                                <div className='flex justify-center gap-x-8'>
                                    <button
                                    onClick={()=>setIsCartFoodModal(false)} 
                                     className='btn btn-success btn-outline w-50'>No</button>
                                    <button onClick={()=>{
                                        handleDeleteFoodFromCart()
                                        setIsCartFoodModal(false)
                                        }} className='w-64 btn btn-error btn-outline'>Yes</button>
                                </div>
                            </label>
                        </label>
                    </div>
