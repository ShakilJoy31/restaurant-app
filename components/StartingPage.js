    ...
    return (
        <div style={{
            ...
            <div className='flex justify-center'>
                ...
                }} onClick={handleGetStartedButton} className="text-xl normal-case btn btn-error">Get Started<span className='ml-2'><GiFoodChain size={30}></GiFoodChain></span>...</button>
            </div>
        </div>
    )
}
